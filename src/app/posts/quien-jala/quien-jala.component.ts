...
@Component({
  selector: 'app-quien-jala',
  templateUrl: './quien-jala.component.html',
  styleUrls: ['./quien-jala.component.css'],
  animations: [
...
export class QuienJalaComponent implements OnInit {
...
onScroll () {
 ...
 LoadMorePosts( numero){
   ...
   console.log("numero load more "+ numero)
    this.postsService
      .LoadMorePostsServicebyCategory(36, numero)
      .subscribe(res => {
        this.posts = res;
