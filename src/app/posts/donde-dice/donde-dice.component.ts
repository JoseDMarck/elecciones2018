...
@Component({
  selector: 'app-donde-dice',
  templateUrl: './donde-dice.component.html',
  styleUrls: ['./donde-dice.component.css'],
  animations: [
...
export class DondeDiceComponent implements OnInit {
...
onScroll () {
 ...
 LoadMorePosts( numero){
   ...
   console.log("numero load more "+ numero)
    this.postsService
      .LoadMorePostsServicebyCategory(31, numero)
      .subscribe(res => {
        this.posts = res;
