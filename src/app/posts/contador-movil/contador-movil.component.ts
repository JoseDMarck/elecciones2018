...
@Component({
  selector: 'app-contador-movil',
  templateUrl: './contador-movil.component.html',
  styleUrls: ['./contador-movil.component.css']
})
export class ContadorMovilComponent implements OnInit {
