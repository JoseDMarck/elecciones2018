...
@Component({
  selector: 'app-que-me-perdi',
  templateUrl: './que-me-perdi.component.html',
  styleUrls: ['./que-me-perdi.component.css'],
  animations: [
...
export class QueMePerdiComponent implements OnInit {
...
onScroll () {
 ...
 LoadMorePosts( numero){
   ...
   console.log("numero load more "+ numero)
    this.postsService
      .LoadMorePostsServicebyCategory(32, numero)
      .subscribe(res => {
        this.posts = res;
