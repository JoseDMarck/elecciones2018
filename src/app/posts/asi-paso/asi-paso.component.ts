...
@Component({
  selector: 'app-asi-paso',
  templateUrl: './asi-paso.component.html',
  styleUrls: ['./asi-paso.component.css'],
  animations: [
...
export class AsiPasoComponent implements OnInit {
...
onScroll () {
 ...
 LoadMorePosts( numero){
   ...
   console.log("numero load more "+ numero)
    this.postsService
      .LoadMorePostsServicebyCategory(30, numero)
      .subscribe(res => {
        this.posts = res;
